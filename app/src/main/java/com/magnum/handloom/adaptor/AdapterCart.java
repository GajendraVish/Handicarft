...
public class AdapterCart extends RecyclerView.Adapter<AdapterCart.ViewHolder> {
    ...
    public void onBindViewHolder(final ViewHolder holder, final int position) {
        ...
        if (Config.ENABLE_DECIMAL_ROUNDING) {
            ...
            holder.product_quantity.setText(single_item_price + " x " + ActivityCart.product_quantity.get(position));
          ...
          // holder.product_price.setText(price + " " + ActivityCart.currency_code.get(position));
            ...
            holder.product_quantity.setText(_single_item  + " x " + ActivityCart.product_quantity.get(position));

         //   holder.product_price.setText(ActivityCart.sub_total_price.get(position) + " " + ActivityCart.currency_code.get(position));
            holder.product_price.setText(ActivityCart.sub_total_price.get(position) + " " + " Rs/-");
        }
        ...
        Picasso.with(context)
                .load(ApiClient.BASE_URL+  ActivityCart.product_image.get(position))
