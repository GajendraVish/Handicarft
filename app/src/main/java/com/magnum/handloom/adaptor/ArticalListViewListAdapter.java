...
import com.magnum.handloom.activity.ActivityCart;
import com.magnum.handloom.response.ArticalInfo;
...
public class ArticalListViewListAdapter extends RecyclerView.Adapter<ArticalListViewListAdapter.MyViewHolder> {

    private List<ArticalInfo> articalInfoList;
    Context context;
    ...
    public ArticalListViewListAdapter(Context context1, List<ArticalInfo> articalInfoList1) {
        this.articalInfoList = articalInfoList1;
    ...
    public void onBindViewHolder(final MyViewHolder holder, final int position) {
        ...
        final ArticalInfo dashboardTopView = articalInfoList.get(position);
...
//                context.startActivity(intent);
    ...
    public int getItemCount() {
        return articalInfoList.size();
    }

    public List<ArticalInfo> getTopViewList() {
